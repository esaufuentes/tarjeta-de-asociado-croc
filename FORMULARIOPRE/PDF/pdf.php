...
<?php foreach ($conn->query('SELECT * FROM person ORDER BY folio DESC LIMIT 1;') as $row){ // SE REALIZA LA CONSULTA . ?> 
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-group">
                                <label class="col-sm-2 control-label">FOTO SELECCIONADA</label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit"  value="DOCUMENTO" name="enviar"  class="btn btn-success" >
                            
                            <a class="btn btn-success"   href="pdf.php">BORRAR FIRMA</a>
                            <a class="btn btn-success"   href="../credencial/pdf.php">GENERAR CREDENCIAL</a>
