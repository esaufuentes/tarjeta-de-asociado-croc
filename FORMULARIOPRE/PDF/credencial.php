                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nombre" value= "<?php echo $row['nombre']?>"  class="form-control"  id="nombre"  readonly="readonly">
                            </div>
                        ...
                        <div class="form-group">
                            <input type="submit"  value="IMPRIMIR DOCUMENTO" href="index.html" name="submit" class="btn btn-success">
                            <input type="submit"  value="IMPRIMIR CREDENCIAL" name="submit" class="btn btn-success">
                            <a class="btn btn-success"   href="pdf.php">BORRAR FIRMA</a>
